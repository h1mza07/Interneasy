...
// Vérifier si l'utilisateur est connecté comme entreprise
...
<head>
    ...
    <title>Dashboard Entreprise - InternEasy</title>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="company-card">
                    <h4>Mes offres</h4>
                    <p>Gérer vos offres de stage</p>
                    <a href="#" class="btn btn-success">Voir mes offres</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="company-card">
                    <h4>Candidatures</h4>
                    <p>Consulter les candidatures reçues</p>
                    <a href="#" class="btn btn-primary">Voir candidatures</a>
                </div>
            </div>
        </div>
